...
1. Checkout to the latest stable branch:
   ...
   {{< alert >}}
   Checking out `releases` will always check out the latest stable release. If you need a specific release, specify a specific `<tag_or_release>`. For example: `git checkout v1.26.0`.
    {{< /alert >}}
