...
- [Devnet](#devnet), the local development network designed to run with minimal resources for develpment testing.
...
TODO - Add devnet use-case and details same as other networks.
TODO - Add devnet paremeters
