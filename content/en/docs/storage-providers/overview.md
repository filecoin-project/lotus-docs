...
- The miner installation is covered in the [Installation guide]({{< relref "../lotus/installation" >}}). Once the installation is complete, the Lotus node, Lotus miner, and Lotus worker applications should all be installed.
