...
If you used the `--no-local-storage` flag during the [miner initialization]({{< relref "../configure/setup#miner-initialization" >}}), you should specify the disk locations for sealing (fast SSD recommended) and long-term storage.
