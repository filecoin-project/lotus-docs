...
| -------------------------- | ------------------------------ | -------- | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Sealing: preCommit phase 1 | Yes (1 core or 1 core-complex) | No       | 128GiB                 | PoRep SDR encoding. Not amenable to parallelization. Core usage depends on value of [`FIL_PROOFS_USE_MULTICORE_SDR`](https://github.com/filecoin-project/rust-fil-proofs/). Also see the [Lotus seal workers guide]({{< relref "../../../workers/seal-workers.md" >}}). |
...
Note that the Lotus implementation allows to configure and delegate specific sealing phases to [Lotus workers]({{< relref "../../../workers/seal-workers.md" >}}).
