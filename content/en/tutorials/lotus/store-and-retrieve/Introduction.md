...
| [Store data]({{< relref "store-data/index.md" >}} "Store data") | 1. Package your data.<br> 2. Import your data into Lotus.<br> 3. Find a storage provider through the Filecoin Plus Registry.<br> 4. Create a storage deal.<br> 5. Wait for the deal to complete. |
| [Retrieve data]({{< relref "retrieve-data/index.md" >}} "Retrieve Data") | 1. Create a retrieval deal.<br> 2. Download your data.|

It will take about an hour to complete these tutorials. While there aren't too many steps involved, there is a bit of waiting around for the network to process your requests.
