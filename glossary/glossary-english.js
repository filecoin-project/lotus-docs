export default {
  ...
  ['attofil']: {
    title: 'attoFIL',
    value:
      'AttoFIL is a word used to describe 10^-18 FIL. The word atto comes from the Norwegian and Danish term: atten eighteen.',
  },
  ['fil']: {
    title: 'FIL',
    value:
      'A ticker symbol is an abbreviation used to uniquely identify Filecoin when it is used in a wallet exchange or a cryptocurrency exchange.',
  },
  ['epost']: {
    title: 'Election Proof-of-Spacetime',
    value:
      'Election Proof-of-Spacetime couples the Proof-of-Spacetime process with block production, meaning that in order to produce a block, the miner must produce a valid Proof-of-Spacetime proof (snark output).',
  },
  ['jwt']: {
    title: 'JWT',
    value:
  ...
  ['json-rpc']: {
    title: 'JSON-RPC',
    value:
      'JSON-RPC is a remote procedure call protocol encoded in JSON. It is a very simple protocol (and very similar to XML-RPC), defining only a few data types and commands.',
  },
  ['bls-address']: {
    title: 'BLS Signature (Address)',
    value:
      'A Boneh–Lynn–Shacham (BLS) signature is a digital signature scheme that allows a user to determine the authenticity of a signer, and is a commonly used signature scheme in the Filecoin Distributed Storage Network.',
  },
  ['faucet']: {
  ...
  ['miner-power']: {
    title: 'Miner Power',
    value:
      'Miner storage in relation to network storage, tracked in the power table.',
  },
  ['sector']: {
    title: 'Sector',
  ...
  ['filecoin-decentralized-storage-market']: {
    ...
    value:
      'Storage Market subsystem is the data entry point into the network. Storage miners only earn power from data stored in a storage deal and all deals live on the Filecoin network.',
  },
  ...
  ['lotus-devnet']: {
    title: 'DevNet',
    value:
      'On the DevNets, you can store data as a storage client and also try how Filecoin mining works. The devnets are an important development tool for those who anticipate building applications on top of the Filecoin protocol or storing data on the decentralized storage market. ',
  },
  ...
  ['block-rewards']: {
    title: 'Block Reward',
    value:
      'Over the entire lifetime of the protocol, 1,400,000,000 FIL (TotalIssuance) will be given out to miners. The rate at which the funds are given out is set to halve every six years, smoothly (not a fixed jump like in Bitcoin).',
  },
  ...
  ['swarm-port']: {
    ...
    value:
      'The LibP2P Swarm manages groups of connections to peers, handles incoming and outgoing streams, and is part of the storage miners implementation. The port value is part of the Host interface.',
  },
  ['daemon']: {
    title: 'Lotus Daemon',
    value:
      'A Daemon is a program that runs as a background process. A Daemon in the context of the Filecoin Distributed Storage Network may enable applications to communicate with peers, handle protocols, participate in pubsub, and interact with a distributed hash table (DHT).',
  },
  ['storage-deal']: {
    title: 'Storage deal',
    value:
      'One of the two types of deals in Filecoin markets. Storage deals are recorded on the blockchain and enforced by the protocol.',
  },
  ['retrieval-deal']: {
    title: 'Retrieval deal',
    value:
      'One of the two types of deals in Filecoin markets. Retrieval deals are off chain and enabled by micropayment channel by transacting parties.',
  },
  ['deal-cid']: {
    title: 'Deal CID',
    value:
      'CID is a format for referencing content in distributed information systems, it is a way to store information so it can be retrieved based on its content, not its location. DealCID specifically is used in storage deals.',
  },
  ['data-cid']: {
    title: 'Data CID',
    value:
      'CID is a format for referencing content in distributed information systems, it is a way to store information so it can be retrieved based on its content, not its location. DataCID specifically is used to represent the file that is stored in the Filecoin Distributed Storage Network.',
  },
  ['cid']: {
    title: 'CID',
    value:
  ...
  ['total-network-power']: {
    ...
    value:
      'A reference to all the Power Tables for every subchain, accounting for each Lotus Storage Miner on chain.',
  },
  ['chain-block-height']: {
    title: 'Chain Block Height',
    value:
      'Chain block height is defined as the number of blocks in the chain between any given block and the very first block in the blockchain.',
  },
  ['block-height']: {
    title: 'Block Height',
    value:
      'Height of the Merkle Tree of a sector. A sector is a contiguous array of bytes that a miner puts together, seals, and performs Proofs of Spacetime on.',
  },
  ['blocktime']: {
    title: 'Blocktime',
